...
\begin{enumerate}
  ...
  \item Duplicate the dataset and replace-impute income variables from the SPI in the second half of households.\footnote{At this point in the process, the resultant dataset contains six version of the FRS, and only the second (the 2019-20 FRS) has nonzero weights.}
  \item Optimise weights to minimise survey loss using gradient descent.
\end{enumerate}
